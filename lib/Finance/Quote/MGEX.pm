...
sub mgex_quotes {
  ...
  # split into symbols Ixxx which are aquote and the rest wquote
  my @aq_keys;
  my %aq_symbol_list;
  ...
  foreach my $aq (@aq_keys) {
    ...
    $req->user_agent ("Finance::Quote::MGEX/$VERSION " . $req->user_agent);
    ### req: $req->as_string
...
=for Finance_Quote_Grab symbols MWZ11
...
=for Finance_Quote_Grab symbols MWZ11 KEZ11 ZWZ11 ICU11 IHU11 IPU11 ISU11 IWU11
...
The "Z11" or "U11" is the contract month letter and the year "11" for 2011.
The month letters are the usual U.S. futures style
